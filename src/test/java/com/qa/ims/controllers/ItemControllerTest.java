...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String I_NAME = "Cooker";
		final double P = 650;
		final Item created = new Item(I_NAME, P);

		Mockito.when(utils.getString()).thenReturn(I_NAME);
		Mockito.when(utils.getDouble()).thenReturn(P);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "Laptop", 250));
	...
	public void testUpdate() {
		Item updated = new Item(1L, "TV", 150);
